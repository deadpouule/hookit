...
/// @title BaseHook
/// @notice Minimal Uniswap v4 hook base (permission validation + PoolManager gate).
abstract contract BaseHook is IHooks {
    ...
    /// @dev Overridden in tests that etch bytecode onto a pre-mined address after construction.
