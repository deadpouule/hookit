...
const INK_BALANCED_AGGREGATOR = getAddress("0x787226725e37017799B1edf6E944309a05607Fe5");
...
const INK_NATIVE_TOKEN = getAddress("0xF91BAaB0043bE02c5a1774ed837eaFEA3b283f38");
