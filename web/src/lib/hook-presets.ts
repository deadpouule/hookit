...
const PRESET_LINES: Record<MasterHookId, string[]> = {
  ...
  "max-tx": [
    `DEFAULT ${bpsToPct(LAUNCH.maxTxBps)} OF TOTAL SUPPLY PER SWAP`,
    "CHECKED ON EXACT-INPUT SWAPS",
    "REVERTS OVERSIZE TX",
    "LAUNCHER PICKS % OF SUPPLY · FIXED AT LAUNCH",
  ],
  "max-wallet": [
    `DEFAULT ${bpsToPct(LAUNCH.maxWalletBps)} OF SUPPLY PER WALLET`,
    "CHECKED AFTER BUYS",
    "LAUNCHER PICKS % OF SUPPLY · FIXED AT LAUNCH",
  ],
  "dynamic-fees": [
    ...
    `MAX HOOK TAX ${MAX_HOOK_TAX_BPS / 100}%`,
    "NO ORACLE · QUOTE-ONLY DEDUCTION",
  ],
  "buyback-vesting": [
