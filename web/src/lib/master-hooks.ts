...
export const MASTER_HOOKS: MasterHook[] = [
  ...
  },
  {
    ...
    number: 4,
    title: "Max Tx",
    description: "limits each swap to a % of total supply you pick — fixed at launch",
    category: "protection",
    icon: Gauge,
    theme: "nature",
    keyword: "TX",
    ...
    summary: "1 active hook block • per-swap supply limit",
    settings: ["+ MAX TX BPS ON", "+ LIMIT PER SWAP VS SUPPLY", "+ REVERTS OVERSIZE SWAPS"],
  },
  {
    id: "max-wallet",
    number: 5,
    title: "Max Wallet",
    description: "limits each wallet to a % of total supply you pick — fixed at launch",
    category: "protection",
    icon: Wallet,
    theme: "ice",
    keyword: "WALLET",
    ...
    summary: "1 active hook block • per-wallet supply limit",
    settings: ["+ MAX WALLET BPS ON", "+ LIMIT PER WALLET VS SUPPLY", "+ CHECKED AFTER BUYS"],
  },
  {
    id: "dynamic-fees",
    number: 6,
